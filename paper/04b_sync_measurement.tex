...
about \SI{5}{\milli\metre\per\second} of apparent velocity disagreement --- ten times
smaller than the \SI{50.5}{\milli\metre\per\second} RMSE of the inertial baseline measured
in Section~\ref{sec:imu_baseline}. The synchronisation is therefore not the limiting term in any
