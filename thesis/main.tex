% ═══════════════════════════════════════════════════════════════════════════
% PhD Dissertation - Complete Version with All 17 Chapters
% A Real-Time Inertial Measurement System for Velocity-Based Training
% ═══════════════════════════════════════════════════════════════════════════
...
\input{chapters/04_hardware}
\input{chapters/05_firmware}
\input{chapters/06_host_software}
\input{chapters/07_pipeline}
\input{chapters/08_segmentation}
\input{chapters/09_validation}
\input{chapters/10_fpga}
\input{chapters/11_asic}
\input{chapters/12_conclusion}
\input{chapters/13_methodology}
\input{chapters/14_error_analysis}
\input{chapters/15_commercialization}
\input{chapters/16_opensource}
\input{chapters/17_related_work}
